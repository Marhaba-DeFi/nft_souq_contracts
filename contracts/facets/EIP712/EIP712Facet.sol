...
contract EIP712 {
    ...
    function eip712FacetInit(string memory name_, string memory version_) public {
        ...
        es._HASHED_NAME = hashedName;
        es._HASHED_VERSION = hashedVersion;
        es._CACHED_CHAIN_ID = block.chainid;
        es._CACHED_DOMAIN_SEPARATOR = _buildDomainSeparator(typeHash, hashedName, hashedVersion);
        es._CACHED_THIS = address(this);
        es._TYPE_HASH = typeHash;
    }
    ...
    function _domainSeparatorV4() internal view returns (bytes32) {
        ...
        if (address(this) == es._CACHED_THIS && block.chainid == es._CACHED_CHAIN_ID) {
            ...
            return _buildDomainSeparator(es._TYPE_HASH, es._HASHED_NAME, es._HASHED_VERSION);
        }
    }
